...
class HomePage extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          if (controller.isLoading.value) return const HomeSkeleton();
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child: BannerWidget(
                  ...
                  onBannerTap: (banner) {
                    ...
                    if (id > 0) {
                      if (type == 10) {
                        Get.toNamed(AppRoutes.albumDetail, arguments: {'id': id});
                      } else if (type == 1000) {
                ...
                SliverToBoxAdapter(child: PlaylistSection(
  ...
  Widget _buildSearchBar(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(margin: const EdgeInsets.fromLTRB(16, 8, 16, 16), height: 40,
        ...
        child: Row(children: [
          ...
          Obx(() {
            final hint = controller.defaultSearch.value.isNotEmpty
                ? controller.defaultSearch.value
                : '搜索音乐、歌手、歌词';
            return Text(hint, style: const TextStyle(fontSize: 13, color: AppColors.textTertiary));
          }),
        ])),
    );
  }
  ...
  Widget _buildNewSongs() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      ...controller.newSongs.take(9).toList().asMap().entries.map((entry) =>
        _songTile(entry.value, entry.key)),
    ]);
  }
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                final id = item['id'];
                if (id != null) {
                  Get.toNamed(AppRoutes.mvDetail, arguments: {'mvid': id});
                }
              },
              child: ClipRRect(borderRadius: BorderRadius.circular(14),
                child: Container(width: 140, color: AppColors.surface,
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(padding: const EdgeInsets.fromLTRB(16, 20, 16, 12),
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          GestureDetector(onTap: () => Get.toNamed(AppRoutes.podcast),
      ...
      SizedBox(height: 130,
        child: ListView.separated(scrollDirection: Axis.horizontal,
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              onTap: () {
                final id = item['id'] ?? item['programId'];
                if (id != null) {
                  Get.toNamed(AppRoutes.djDetail, arguments: {'id': id});
                }
              },
              child: Column(children: [
                ClipRRect(borderRadius: BorderRadius.circular(14),
                  child: Container(width: 100, height: 100, color: AppColors.surface,
